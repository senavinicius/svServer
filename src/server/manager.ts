...
import { validateDomain, validateDocumentRoot, escapeShellArg } from './validation.js';
import { generateNodeVirtualHost, generateStaticVirtualHost } from './vhost-templates.js';
import { execCommand, writeProtectedFile } from './file-operations.js';

const VHOST_HTTP_PATH = '/etc/httpd/conf.d/vhost.conf';
const VHOST_HTTPS_PATH = '/etc/httpd/conf.d/vhost-le-ssl.conf';

// Re-export validation functions for backward compatibility
export { validateDomain, validateDocumentRoot } from './validation.js';
